		    ...
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <c:if test="${taskList != null && taskList.size()>0 }">
		      	<c:forEach items="${taskList}" var="tl">
		      		<tr>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${tl.id }</div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${tl.name }</div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${tl.createTime }</div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${tl.assignee }</div></td>
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a href="${pageContext.request.contextPath }/viewTaskForm.htm?taskId=${tl.id }">[办理任务]</a>||
							<a target="_blank" href="viewCurrentImage.htm?taskId=${tl.id }">查看当前流程图</a>
				        </div></td>
				    </tr> 
		      	</c:forEach>
		      </c:if>
