...
<body>
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		   ...
		   <c:if test="${depList != null && depList.size() > 0 }">
		      	...
		      	<c:forEach items="${depList }" var="work">
		      		<tr>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${work.id}</div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${work.name}</div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${work.deploymentTime}</div></td>
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a href="delDeployment.htm?deploymentId=${work.id}">删除</a>
				        </div></td>
				    </tr> 
		      </c:forEach>
		        </c:if>
		     ...
		     <c:if test="${pdList != null && pdList.size() > 0}">
    	      	<c:forEach items="${pdList }" var="pd">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a target="_blank" href="viewImage.htm?deploymentId=${pd.deploymentId }/>&imageName=${pd.diagramResourceName }">查看流程图</a> 
					 	</div></td>
				    </tr> 
		      	</c:forEach>
		      	</c:if>
	...
	<br/>
	<!-- 发布流程 -->
	<form action="<%=basePath %>newdeploy.htm" enctype="multipart/form-data" method="POST">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		  ...
		  <tr>
		    <td>
		    	<div align="left" class="STYLE21">
					...
					流程文件:<input type="file" name="pic"><br/>
